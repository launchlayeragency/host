...
export default function ReviewSharedHosting() {
         ...
         >
            <div className="w-[85%] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative  py-12 px-4 md:px-8">
                        ...
                        {testimonialsData.map((testimonial) => (
                            <SwiperSlide key={testimonial.id}>
                                ...
                                <div className="transition-all duration-300 hover:-translate-y-2 md:min-h-80 lg:min-h-96 xl:min-h-72 flex flex-col">
                                    ...
                                    <div className="bg-white  shadow-lg p-6 xl:p-8 flex-1 mb-4">
                                        <p className="text-gray-600 text-base md:text-lg xl:text-xl leading-relaxed italic">
                                            "{testimonial.content}"
                                        </p>
                                    </div>
                    ...
                    <button className="testimonial-prev absolute left-0 top-1/2 -translate-y-1/2 -translate-x-6 z-10 w-10 h-10 bg-white hover:bg-teal-500  flex items-center justify-center transition-all duration-300 shadow-lg border group">
                        <ChevronLeft className="w-6 h-6 text-gray-700 group-hover:text-white transition-colors duration-300" />
                    </button>
                    <button className="testimonial-next absolute right-0 top-1/2 -translate-y-1/2 translate-x-6 z-10 w-10 h-10 bg-white hover:bg-teal-500  flex items-center justify-center transition-all duration-300 shadow-lg border group">

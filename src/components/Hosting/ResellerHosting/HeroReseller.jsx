...
export default function HeroReseller() {
    return (
        <section id='resellerHosting' className="relative h-[500px] md:min-h-[680px] w-full overflow-hidden">
            {/* Background Image */}
            <BgImage />
            ...
            <div className="absolute inset-0 z-10 flex items-center justify-start px-2 sm:px-12 lg:px-24  w-[85%] mx-auto">
                <div className="flex flex-col">
                    ...
                    <p className="text-xl md:text-2xl text-white opacity-90 sm:w-[65%] xl:w-[50%]   mb-6">Reseller Hosting Powered by Hostnet. Exclusive offer for Hostnet customers: Use promo code RH35 for 35% off!*
